...
Unpack the cpustress-2.3.1.7z archive (you probably already did this, else you
couldn't read this README.
$ 7z x "./path/to/file/cpustress-2.3.1.7z"
